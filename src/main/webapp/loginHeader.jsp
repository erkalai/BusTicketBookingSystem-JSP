...
<body>
 <div class="container-fluid " style="background-color: rgba(255, 255, 255, 0.3);">
    <div class="row">
      <div class="col">
        <div class="tel text-secondary ms-1 fw-bold"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
            ...
            <div class="container-fluid ">
              ...
              <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav me-2 mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link navlink text-secondary" aria-current="page" href="adminDashboard.html">Operator Login</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link navlink text-secondary" href="./login.html">SignIn <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
